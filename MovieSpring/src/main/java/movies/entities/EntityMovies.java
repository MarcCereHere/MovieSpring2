...
public class EntityMovies {
	...
	public EntityMovies(boolean adult, String backdrop_path, Long[] genre_ids, Long id, String original_language,
	...
	public String toString() {
		return "EntityMovies [adult=" + adult + ", backdrop_path=" + backdrop_path + ", genre_ids="
