...
public class EntityCrew {
   ...
   public EntityCrew(boolean adult, int gender, Long id, String known_for_department, String name, String original_name,
			float popularity, String profile_path, Long cast_id, String character, String credit_id, Long order) {
		super();
		this.adult = adult;
		this.gender = gender;
		this.id = id;
...
public String toString() {
	return "EntityCrew [adult=" + adult + ", gender=" + gender + ", id=" + id + ", known_for_department="
			...
			+ popularity + ", profile_path=" + profile_path + ", cast_id=" + cast_id + ", character=" + character
